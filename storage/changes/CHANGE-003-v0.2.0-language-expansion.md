...
CodeGraphMCPServer v0.2.0에서는 Go와 Java 언어 지원을 추가하여, 더 많은 프로젝트에서 코드 그래프 분석을 활용할 수 있게 합니다.

### Motivation

- **Go**: 클라우드 네이티브 개발에서 폭넓게 사용 (Kubernetes, Docker 등)
- **Java**: 엔터프라이즈 개발의 핵심 언어 (Spring Boot, Android 등)
...
**Description**: Java 언어 AST 분석기를 구현
**Estimate**: 4 hours
**Dependencies**: None
...
**Description**: Java 언어 파서 테스트를 작성
**Estimate**: 2 hours
