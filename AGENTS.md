# ITDA - CodeGraphMCPServer

A software project using ITDA SDD

## Initialized with ITDA SDD for GitHub Copilot

This project uses **ITDA** (Ultimate Specification Driven Development).
