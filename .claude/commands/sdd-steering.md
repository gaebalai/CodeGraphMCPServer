...
1. **Bootstrap Mode** - No steering files exist
   ...
   - Create both English (.md) and Korean (.ko.md) versions
...
2. **Sync Mode** - Steering files exist, codebase has changed
   ...
   - Preserve both English and Korean versions
...
3. **Generate Steering Files** (Bilingual):
   ...
   **IMPORTANT**: Create BOTH English and Korean versions for each file.
   ...
   **English version is always the reference/source.**
   ...
   Create `steering/structure.ko.md` (Korean) with:
   ...
   Create `steering/tech.ko.md` (Korean) with:
   - Translation of tech.md content
   - Technology names kept in English with Korean explanations
   ...
   Create `steering/product.ko.md` (Korean) with:
...
4. **Bilingual File Generation**:
   ...
   - Then generate Korean translation (.ko.md)
   - English version is the reference for all skills
   - Korean version for Korean-speaking team members
...
- steering/structure.md (+ .ko.md)
- steering/tech.md (+ .ko.md)
- steering/product.md (+ .ko.md)
...
4. **Update Steering Files** (Bilingual):
   ...
   - Then update Korean version (.ko.md) to match
...
3. **Consistency Check**:
   - [ ] English and Korean versions match
